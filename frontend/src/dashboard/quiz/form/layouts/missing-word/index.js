...
function Index({ arrayField }) {
  ...
  return (
    <div className="qlayout_four_wrapper qlayout">
      <div
        dir={layoutDir}
      ...
      >
        {fields.length > 0 ? (
          ...
          <span className="rounded bg-red-200 p-1 text-white">
      ...
      <div className="relative border rounded p-3 mt-4 bg-white shadow-md">
        ...
        <div className="flex items-center mt-4">
          ...
          <button
            className="bg-red-300 px-2 py-1 rounded text-white font-semibold text-sm ml-2"
            onClick={() => setPopup({ open: true, type: "wrong_word" })}
            type="button"
          >
            Add Wrong Word
          </button>
