...
function Item({ idx, id, remove, register, control, cloneData, errors }) {
        ...
        <div className="flex-grow">
          <Input
            register={register(`quizes.${idx}.title`, {
              ...
              maxLength: {
                value: 100,
                message: "title not more than 100 character",
              },
            })}
            invalid={error}
        ...
        <Controller
          ...
          render={({ field: { onChange, value } }) => (
            <div
              ...
              className="w-9 h-9 border border-slate-300 rounded flex flex-col justify-center items-center"
            >
              {value ? (
