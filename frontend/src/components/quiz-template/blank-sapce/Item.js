...
function Item({ item }) {
  ...
  return (
    <div ref={setNodeRef} style={style} {...attributes} {...listeners}>
      <div className={`${quizTitleDirection==='rtl'? "bg-blue-500 hover:bg-blue-600 text-center px-5 py-1 m-1 text-white rounded w-maxinline-block font-naskh text-[20px]":
