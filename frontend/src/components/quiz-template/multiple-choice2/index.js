...
function Layout1({ quiz, nextQ }) {
  ...
  return (
    <div className="bg-gradient-to-r from-blue-50 to-blue-100 p-2 sm:p-3 rounded-2xl shadow-lg pb-[max(0.5rem,env(safe-area-inset-bottom))]">
